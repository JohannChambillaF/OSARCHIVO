					...
					<div class="col-sm-4">
						<div class="row">
							...
							<div class="col-6 text-center" >
								<?php
									$sql = "SELECT * FROM registro	WHERE tipo = 'CONFORMIDAD' && estado = 'INCOMPLETO'";
            ...
            <table class="table table-bordered resultado" align="vertical" id="tablatenc" style="margin-top: 15px;">
				<thead class="table-primary" style='font-size: 11px; color: #626161;'>
					<tr>
						...
						<th class="text-center" style="width: 15%;">FECHA RECEP</th>
		...
		<div class="card-body">
            <form method="POST" id="frm_conf_atencion">
				...
				<div class="form-group" style="text-align: center;">
					<input class="option-input radio" type="radio" name="estado" value="INCOMPLETO">
					<label class="form-check-label" for="inlineRadio1">INCOMPLETO</label>
