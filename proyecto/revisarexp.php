...
<div style="margin: 15px; display: flex; flex-wrap: nowrap;">
	<div class="card col-6"  style="margin-bottom: 15px; border-color:rgba(115 199 101);">
		<div class="card-header" style="background-color: rgba(115 199 101);">
					...
					<div class="col-sm-4">
						<div class="row">
							...
							<div class="col-8 text-center" >
								<?php
									$sql = "SELECT * FROM registro	WHERE tipo = 'OFICIO' && estado = 'REGISTRADO'";
	...
	<div class="card col-6 ms-2"  style="margin-bottom: 15px; border-color:rgba(115 199 101);">
		<div class="card-header" style="background-color: rgba(115 199 101);"><H5 style="color: #FFFF;">Cumplimiento de Requisitos</H5>
		</div>
		<div class="card-body">
...
<div class="w3-container" style="margin: 15px;">
	<div class="card" style="border-color:rgba(115 199 101);">
		<div class="card-header" style="background-color: rgba(115 199 101);"><H5 style="color: #FFFF;">XXXX CAMPO LIBRE</H5></div>
		<div class="card-body">
...
<script>
	$(document).ready(function(){
		$("#filtro").on('click', function(e){//hace referencia a la accion de prescionar el boton
			...
			e.preventDefault();//esto sirve para que la pagina no se recargue
			ofic_filtro();//esta llamando a la funcion creada en funciones.js
